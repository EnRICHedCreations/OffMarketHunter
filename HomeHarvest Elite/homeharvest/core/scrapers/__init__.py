...
class ScraperInput(BaseModel):
    ...
    sort_direction: str | list[str] = "desc"

    # Tag filtering parameters
    tag_filters: list[str] | None = None
    tag_match_type: str = "any"  # "any" (OR), "all" (AND), or "exact" match
...
class Scraper:
    ...
    def __init__(
        ...
        # Tag filtering
        self.tag_filters = scraper_input.tag_filters
        self.tag_match_type = scraper_input.tag_match_type
        self.tag_exclude = scraper_input.tag_exclude

        # Additional property filters
        self.hoa_fee_min = scraper_input.hoa_fee_min
        self.hoa_fee_max = scraper_input.hoa_fee_max
        self.stories_min = scraper_input.stories_min
        self.stories_max = scraper_input.stories_max
        self.garage_spaces_min = scraper_input.garage_spaces_min
        self.garage_spaces_max = scraper_input.garage_spaces_max
        self.has_pool = scraper_input.has_pool
        self.has_garage = scraper_input.has_garage
        self.waterfront = scraper_input.waterfront
        self.has_view = scraper_input.has_view
