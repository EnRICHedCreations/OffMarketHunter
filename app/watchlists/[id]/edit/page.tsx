...
export default function EditWatchlistPage() {
    ...
    const fetchWatchlist = async () => {
      ...
      try {
        ...
        reset({
          ...
          price_min: watchlist.price_min?.toString() || '',
          price_max: watchlist.price_max?.toString() || '',
          beds_min: watchlist.beds_min?.toString() || '',
          beds_max: watchlist.beds_max?.toString() || '',
          baths_min: watchlist.baths_min?.toString() || '',
          baths_max: watchlist.baths_max?.toString() || '',
          sqft_min: watchlist.sqft_min?.toString() || '',
          sqft_max: watchlist.sqft_max?.toString() || '',
          lot_sqft_min: watchlist.lot_sqft_min?.toString() || '',
          lot_sqft_max: watchlist.lot_sqft_max?.toString() || '',
          year_built_min: watchlist.year_built_min?.toString() || '',
          year_built_max: watchlist.year_built_max?.toString() || '',
          track_off_market: watchlist.track_off_market,
          track_price_reductions: watchlist.track_price_reductions,
          track_expired: watchlist.track_expired,
          alert_threshold: watchlist.alert_threshold?.toString() || '80',
        });

        if (watchlist.property_types) {
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Edit Watchlist</h1>
        <p className="mt-2 text-gray-600">
          Update your watchlist settings and criteria
        </p>
      </div>
